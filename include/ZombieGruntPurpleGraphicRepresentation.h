#ifndef ZOMBIE_GRUNT_PURPLE_GRAPHIC_REPRESENTATION_H
#define ZOMBIE_GRUNT_PURPLE_GRAPHIC_REPRESENTATION_H

#include "EnemyGraphicRepresentation.h"

class ZombieGruntPurpleGraphicRepresentation : public EnemyGraphicRepresentation
{
	...
	public:
		ZombieGruntPurpleGraphicRepresentation(int energy);
		virtual ~ZombieGruntPurpleGraphicRepresentation();
