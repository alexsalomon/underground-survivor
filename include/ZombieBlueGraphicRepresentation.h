#ifndef ZOMBIE_BLUE_GRAPHIC_REPRESENTATION_H
#define ZOMBIE_BLUE_GRAPHIC_REPRESENTATION_H

#include "EnemyGraphicRepresentation.h"

class ZombieBlueGraphicRepresentation : public EnemyGraphicRepresentation
{
	...
	public:
		ZombieBlueGraphicRepresentation(int energy);
		virtual ~ZombieBlueGraphicRepresentation();
